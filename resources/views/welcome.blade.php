    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
          ...
          <div class="container px-6 mx-auto grid">
            <h2
              class="my-6 text-2xl font-semibold text-dark"
            >
              List Seluruh Data Postingan
            </h2>
            <!-- CTA -->
            </div>
                ...
                <table class="w-full whitespace-no-wrap">
                  <thead>
                      <tr
                          ...
                          <th class="px-4 py-3">send to email</th>
                      </tr>
                  </thead>
                      ...
                      @foreach ($mailData as $post)
                          <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="flex items-center space-x-4 text-sm">
                                <form action="{{ route('kirim.show') }}" method="get" class="d-inline">
                                    @csrf
                                    <button
